...
class GameObject(MapObject):
    ...
    def toString(self):
        return ((((((u"{" + HxOverrides.stringOrNull(self.type)) + u" Id: ") + Std.string(
            self.id)) + u", Owner: ") + Std.string(self.owner.id)) + u"}")
...
class Iceberg(GameObject):
    ...
    __slots__ = (
    u"penguin_amount", u"_hx___penguin_group_max_speed", u"is_icepital", u"upgrade_value", u"upgrade_cost", u"level",
    u"upgrade_level_limit", u"cost_factor", u"_hx___can_upgrade_object", u"penguins_per_turn")
    _hx_fields = [u"penguin_amount", u"__penguin_group_max_speed", u"is_icepital", u"upgrade_value", u"upgrade_cost",
                  u"level", u"upgrade_level_limit", u"cost_factor", u"__can_upgrade_object", u"penguins_per_turn"]
    ...
    def get_turns_till_arrival(self, destination):
        turns = ((self._hx___distance(destination) * 1.0) / self._hx___penguin_group_max_speed)
        x = Math.ceil(turns)
        try:
            return int(x)
    ...
    def can_send_penguins(self, destination, penguinAmount):
        if (not Std._hx_is(destination, Iceberg)):
            return False
        if (((penguinAmount > self.penguin_amount) or ((self.penguin_amount < 1))) or (
        ((destination == self) and ((penguinAmount < 1))))):
            return False
        return True
    ...
    def send_penguins(self, destination, penguinAmount):
        if (not Std._hx_is(destination, Iceberg)):
            print
            u"The destination is not a Iceberg!, Check your parameters"
            return
        ...
        orderArgs = (((u"\"destination\": " + Std.string(
            destination.unique_id)) + u", \"penguin_amount\": ") + Std.string(penguinAmount))
...
class Location(MapObject):
    ...
    _hx_methods = [u"__getLocation", u"equals", u"add", u"subtract", u"multiply", u"__add__", u"__sub__", u"__mul__",
                   u"__rmul__", u"hashCode", u"toString", u"__inRange", u"__distance", u"towards"]
...
class ObjectParser(object):
    ...
    __slots__ = ()
    _hx_statics = [u"__loadVectorOfBaseObjects_Player", u"__loadVectorOfBaseObjects_Iceberg",
                   u"__loadVectorOfBaseObjects_Location", u"__loadVectorOfBaseObjects_PenguinGroup",
                   u"__loadVectorOfBaseObjects_GameObject", u"__loadVectorOfBaseObjects_MapObject",
                   u"__loadVectorOfBaseObjects_PirateGame", u"__loadVectorOfBaseObjects_BaseObject",
                   u"__loadVectorBuiltins_Bool", u"__loadVectorBuiltins_String", u"__loadVectorBuiltins_Int",
                   u"__submittedObjects", u"__submittedTemporaryObjects", u"__objectsWaitList", u"__currentNamespace",
                   u"__gameObjectClasses", u"_nativeAPI", u"_parseTurn", u"__submitObject", u"__updateObjects",
                   u"__loadObject", u"__loadFields", u"__loadVectorOfUnknownType", u"__addPromise", u"__fulfilPromise",
                   u"__createEmptyInstance", u"__getField", u"__setField"]
...
class PenguinGroup(GameObject):
    ...
    __slots__ = (u"source", u"destination", u"penguin_amount", u"turns_till_arrival", u"current_speed")
    _hx_fields = [u"source", u"destination", u"penguin_amount", u"turns_till_arrival", u"current_speed"]
...
class Game(BaseObject):
    ...
    u"_hx___nativeAPI", u"_hx___icepital_holders", u"_hx___neutral", u"_hx___rows", u"_hx___cols",
    u"_hx___all_icebergs", u"max_turns_without_icepital", u"acceleration_cost", u"acceleration_factor")
    _hx_fields = [u"__players", u"__turnTime", u"__turnStartTime", u"__numPlayers", u"__recoverErrors",
                  ...
                  u"__nativeAPI", u"__icepital_holders", u"__neutral", u"__rows", u"__cols", u"__all_icebergs",
                  u"max_turns_without_icepital", u"acceleration_cost", u"acceleration_factor"]
    _hx_methods = [u"_nextTurn", u"_shouldRecoverErrors", u"isFilePosInBot", u"_addOrder", u"_addMoveOrder",
                   u"_getActions", u"debug", u"get_myself", u"get_enemy", u"get_all_players", u"get_time_remaining",
                   u"get_max_turn_time", u"get_all_icepital_icebergs", u"get_my_icepital_icebergs",
                   u"get_enemy_icepital_icebergs", u"get_neutral_icepital_icebergs", u"get_neutral",
                   u"get_all_penguin_groups", u"get_my_penguin_groups", u"get_enemy_penguin_groups", u"_moveOrder",
                   u"get_neutral_icebergs", u"get_all_icebergs", u"get_my_icebergs", u"get_enemy_icebergs"]
    _hx_statics = [u"__getObjectsOfEnemyPlayers_Iceberg", u"__getObjectsOfPlayer_Iceberg", u"UNKNOWN_ORDER_FILE_NAME",
                   u"UNKNOWN_ORDER_LINE_NUMBER"]
    _hx_interfaces = []
    _hx_super = BaseObject
    ...
    def __init__(self, nativeAPI):
        ...
        self._hx___icepital_holders = None
    ...
    def _addOrder(self, orderType, actor, args=u""):
        if (args is None):
            args = u""
        orderOriginPosition = ((((
                                             u"{ \"file_name\": \"" + u"__UNKNOWN_FILE_NAME__") + u"\", \"line_number\": ") + Std.string(
            -1)) + u" }")
        ...
        while (_g < len(cs)):
            ...
            if (item.index == 2):
                ...
                if self.isFilePosInBot(method, file):
                    orderOriginPosition = ((((u"{ \"file_name\": \"" + HxOverrides.stringOrNull(
                        HxString.substr(file, (file.rfind(u"/", 0, len(file)) + 1),
                                        None))) + u"\", \"line_number\": ") + Std.string(line)) + u" }")
                    actor.already_acted = True
                    break
        order = ((((((((u"{ \"order_type\": \"" + (
            u"null" if orderType is None else orderType)) + u"\", \"actor\": ") + Std.string(
            actor.unique_id)) + u", \"order_args\": {") + (
                        u"null" if args is None else args)) + u"}, \"position\": ") + (
                      u"null" if orderOriginPosition is None else orderOriginPosition)) + u" }")
        _this = self._hx___orders
        _this.append(order)

    def _addMoveOrder(self, order, actor, dest):
        orderArgs = ((((u"\"destination\": [" + Std.string(dest._hx___getLocation().row)) + u", ") + Std.string(
            dest._hx___getLocation().col)) + u"]")
    ...
    def get_all_icepital_icebergs(self):
        this1 = self._hx___icepital_holders
        this2 = [None] * len(this1)
        r = this2
        haxe_ds__Vector_Vector_Impl_.blit(this1, 0, r, 0, len(this1))
        return r
    ...
    def get_my_icepital_icebergs(self):
        return Game._hx___getObjectsOfPlayer_Iceberg(self._hx___icepital_holders, self._hx___me)

    def get_enemy_icepital_icebergs(self):
        return Game._hx___getObjectsOfEnemyPlayers_Iceberg(self._hx___icepital_holders, self._hx___me)
    ...
    def _hx_empty_init(_hx_o):
        ...
        _hx_o._hx___icepital_holders = None
...
class python_Boot(object):
                ...
                if hasParams:
                    ...
                    while (_g12 < _g3):
                        ...
                        paramsStr = ((u"null" if paramsStr is None else paramsStr) + HxOverrides.stringOrNull(((
                                ...
                                python_Boot.toString1((o2.params[i1] if i1 >= 0 and i1 < len(o2.params) else None),
                                                      s))))))
                    return (((HxOverrides.stringOrNull(o2.tag) + u"(") + (
    ...
    def simpleField(o, field):
        if (field is None):
            return None
        field1 = ((u"_hx_" + field) if ((field in python_Boot.keywords)) else ((u"_hx_" + field) if ((
    ...
    def field(o, field):
        ...
        if (_hx_local_0 == 10):
            ...
            pass
        field2 = ((u"_hx_" + field) if ((field in python_Boot.keywords)) else ((u"_hx_" + field) if ((
                    (((len(field) > 2) and ((ord(field[0]) == 95))) and ((ord(field[1]) == 95))) and (
            (ord(field[(len(field) - 1)]) != 95)))) else field))
        if hasattr(o, field2):
...
class python_internal_ArrayImpl(object):
    ...
    def lastIndexOf(a, x, fromIndex=None):
        _hx_len = len(a)
        l = (_hx_len if ((fromIndex is None)) else (
